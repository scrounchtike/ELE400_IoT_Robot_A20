...
typedef uint32_t ATCustom_BG96_QINISTAT_t;
#define QCINITSTAT_INITIALSTATE    ((ATCustom_BG96_QINISTAT_t) 0x0)
#define QCINITSTAT_CPINREADY       ((ATCustom_BG96_QINISTAT_t) 0x1)
#define QCINITSTAT_SMSINITCOMPLETE ((ATCustom_BG96_QINISTAT_t) 0x2)
#define QCINITSTAT_PBINITCOMPLETE  ((ATCustom_BG96_QINISTAT_t) 0x4)
...
typedef enum
{
  ...
  QENGcelltype_ServingCell    = 0x0, /* get 2G or 3G serving cell information */
  QENGcelltype_NeighbourCell  = 0x1, /* get 2G or 3G neighbour cell information */
  QENGcelltype_PSinfo         = 0x2, /* get 2G or 3G cell information during packet switch connected */
} ATCustom_BG96_QENGcelltype_t;

/* QIOPEN service type parameter */
typedef uint8_t ATCustom_BG96_QIOPENservicetype_t;
#define QIOPENSERVICETYPE_TCP_CLIENT  (ATCustom_BG96_QIOPENservicetype_t)(0x0U)
#define QIOPENSERVICETYPE_UDP_CLIENT  (ATCustom_BG96_QIOPENservicetype_t)(0x1U)
#define QIOPENSERVICETYPE_TCP_SERVER  (ATCustom_BG96_QIOPENservicetype_t)(0x2U)
#define QIOPENSERVICETYPE_UDP_SERVICE (ATCustom_BG96_QIOPENservicetype_t)(0x3U)
...
typedef struct
{
  ...
  at_bool_t                         QICGSP_config_command;  /* memorize if QICSGP write command is a config or a query command */
  bg96_qiurc_dnsgip_t               QIURC_dnsgip_param;     /* memorize infos received in the URC +QIURC:"dnsgip" */
  at_bool_t                         QINISTAT_error;         /* memorize AT+QINISTAT has reported an error (not supported by FW version) */
