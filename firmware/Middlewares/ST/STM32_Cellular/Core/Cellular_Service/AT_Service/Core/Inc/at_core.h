...
#define ATACTION_SEND_WAIT_MANDATORY_RSP ((at_action_send_t) 0x0001) /* Wait a response (mandatory: if not received, this is an error) */
#define ATACTION_SEND_TEMPO              ((at_action_send_t) 0x0002) /* Temporisation for waiting an eventual response or event */
#define ATACTION_SEND_ERROR              ((at_action_send_t) 0x0004) /* Error: unknown msg, etc... */
#define ATACTION_SEND_FLAG_LAST_CMD      ((at_action_send_t) 0x8000)  /* when this flag is set, this is the final command */
...
#define ATACTION_RSP_FRC_END            ((at_action_rsp_t) 0x0001) /* Received Final Result Code (OK, CONNECT...), no more AT command to send */
#define ATACTION_RSP_FRC_CONTINUE       ((at_action_rsp_t) 0x0002) /* Received Final Result Code (OK, CONNECT...), still AT command to send */
...
#define ATACTION_RSP_URC_IGNORED        ((at_action_rsp_t) 0x0020) /* Result Code received, to ignore (default) */
#define ATACTION_RSP_URC_FORWARDED      ((at_action_rsp_t) 0x0040) /* Unsolicited Result Code received, to forward to client */
#define ATACTION_RSP_FLAG_DATA_MODE     ((at_action_rsp_t) 0x8000) /* when this flag is set, DATA mode activated in modem */
