...
#define CS_CM_COMMAND_MODE              (CS_ConnectionMode_t)(0x0U) /* remains in command line after each packet transmission (tx or rx) - default */
#define CS_CM_ONLINE_MODE               (CS_ConnectionMode_t)(0x1U) /* NOT SUPPORTED - remains in online mode until transfer over socket is closed */
#define CS_CM_ONLINE_AUTOMATIC_SUSPEND  (CS_ConnectionMode_t)(0x2U) /* NOT SUPPORTED - remains in online mode until a suspend timeout expires */
