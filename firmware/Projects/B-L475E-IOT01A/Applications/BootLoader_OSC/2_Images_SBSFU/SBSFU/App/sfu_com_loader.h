...
/** @addtogroup SFU_COM_LOADER  SFU Com Local Loader
  * @{
  */
...
/** @defgroup SFU_COM_LOADER_Exported_Types Exported Types
  * @{
  */
...
/** @defgroup SFU_COM_LOADER_Exported_Constants Exported Constants
  * @{
  */

/** @defgroup SFU_COM_LOADER_YMODEM_Packet_Constants Ymodem Packet Structure Constants
  * @{
  */
...
#define SFU_COM_YMODEM_PACKET_OVERHEAD_SIZE    (SFU_COM_YMODEM_PACKET_HEADER_SIZE + SFU_COM_YMODEM_PACKET_TRAILER_SIZE - 1U) /*!<Overhead Size*/
...
/** @defgroup SFU_COM_LOADER_YMODEM_File_Constants Ymodem File Constants
  * @{
  */
...
/** @defgroup SFU_COM_LOADER_YMODEM_Protocol_Constants Ymodem Protocol defines
  * @{
  */
...
/** @addtogroup SFU_COM_LOADER_Exported_Functions
  * @{
  */

/** @addtogroup SFU_COM_LOADER_Initialization_Functions
  * @{
  */
/*
...
/** @addtogroup SFU_COM_LOADER_Control_Functions
  * @{
  */
...
/** @addtogroup SFU_COM_LOADER_Callback_Functions
  * @{
  */
