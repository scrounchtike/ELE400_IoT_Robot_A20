...
/** @addtogroup SFU_ERROR
  * @{
  */

/** @defgroup SFU_ERROR_Exported_Types Exported Types
  * @{
  */

/** @defgroup SFU_EXCPT_ID_Structure_definition SFU EXCPT ID Type definition.
  * @{
  */
/**
...
typedef enum
{
  SFU_EXCPT_NONE = 0x00U,
  /* System errors */
  SFU_EXCPT_FIREWALL_RESET,
  ...
  SFU_EXCPT_ROLLBACK_PREV_USER_FW_ERR,
  SFU_EXCPT_EXECUTE_USER_FW_ERR,
  /* Specific errors */
  SFU_EXCPT_MAX_CONSEC_ERRORS_REACHED,
  SFU_EXCPT_LOCK_SE_SERVICES_ERR,
#if defined(SECBOOT_USE_LOCAL_LOADER)
  SFU_EXCPT_INCONSISTENT_FW_SIZE, /* The size of the binary is not the same as the size specified in the header */
  ...
  SFU_EXCPT_DOWNLOAD_ERROR,       /* Download issue */
  ...
  SFU_EXCPT_INCORRECT_BINARY,     /* Incorrect binary format */
  SFU_EXCPT_FLASH_ERROR,           /* Problem with FLASH */
  SFU_EXCPT_FWIMG_MAGIC,           /* Problem with a FWIMG pattern */
  SFU_EXCPT_FWIMG_SWAP,            /* Problem while swapping the images in slot #0 and slot #1 */
...
/** @defgroup SFU_ERROR_Exported_Macros Exported Macros
  * @{
  */
...
/** @defgroup SFU_ERROR_ErrorStrings Error Strings
  * @brief Error strings matching the SFU exceptions for debug prints.
  * @{
  */
...
/** @addtogroup SFU_ERROR_Exported_Functions
  * @{
  */

/** @addtogroup SFU_ERROR_ERRORS_Functions Error Management Functions
 * @{
 */
...
/** @addtogroup SFU_EXCPT_Initialization_Functions
  * @{
  */
...
/** @addtogroup SFU_EXCPT_ExportedCtrl_Functions
  * @{
  */
