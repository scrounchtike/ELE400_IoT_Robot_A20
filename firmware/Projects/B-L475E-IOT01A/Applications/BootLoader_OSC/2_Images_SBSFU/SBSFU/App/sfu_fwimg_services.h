...
typedef enum
{
  ...
  SFU_IMG_FWUPDATE_STOPPED,            /*!< A previous installation has been interrupted before it completed (recovery pending) */
...
/** @addtogroup SFU_IMG_Service_Functions_Reinstall Image re-installation services
  * @{
  */
