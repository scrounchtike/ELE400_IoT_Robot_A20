...
/** @defgroup  SFU_COM_TRACE  SFU Com Trace
  * @brief This file provides a set of  functions to manage the Comms interface used for trace.
  * @{
  */


/** @defgroup SFU_COM_TRACE_Private_Defines Private Defines
  * @{
  */
...
/** @defgroup SFU_COM_TRACE_Exported_Functions Exported Functions
  * @{
  */

/** @defgroup SFU_COM_TRACE_Initialization_Functions Initialization Functions
  * @{
  */
