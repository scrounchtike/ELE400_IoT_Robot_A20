...
* backup and restore the previous active image when a failure occurs
...
Caution: Make sure to use an up-to-date version of ST-LINK firmware (V2.J29 or later) else SBSFU may not start.
...
8. Send the user encrypted firmware file (\2_Images\2_Images_UserApp\Binary\UserApp.sfb) with Tera Term by using 
   menu "File > Transfer > YMODEM > Send..."
