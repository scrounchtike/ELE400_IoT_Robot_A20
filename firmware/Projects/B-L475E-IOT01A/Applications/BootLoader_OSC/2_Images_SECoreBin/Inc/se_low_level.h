...
/* Secure Engine needs to know the slot 0 definition for the Read/Write services in protected area (see @ref SE_IMG_Write, see @ref SE_IMG_Read) */
...
/**
  ...
  * The CRC is computed with the structure without its CRC field and the length is provided to SE_CRC_Calculate in 32-bit word.
 ...
 */
/* Switch disabled because Firewall isolation is available. */
